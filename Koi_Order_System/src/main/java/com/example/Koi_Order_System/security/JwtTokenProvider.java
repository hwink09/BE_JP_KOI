...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new KoiApiException(HttpStatus.BAD_REQUEST, "Invalid JWT token");
        } catch (ExpiredJwtException e) {
            throw new KoiApiException(HttpStatus.BAD_REQUEST, "Expired JWT token");
        } catch (UnsupportedJwtException e) {
            throw new KoiApiException(HttpStatus.BAD_REQUEST, "Unsupported JWT token");
        } catch (IllegalArgumentException e) {
            throw new KoiApiException(HttpStatus.BAD_REQUEST, "JWT claims string is empty");
        }
    }
